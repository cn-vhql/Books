...
> {
    ...
    return optionList.map((item) => {
      ...
      return (
        <SettingFormRow
          ...
          desc={item.desc ? <Trans>{item.desc}</Trans> : undefined}
          control={
            <span
  ...
  render() {
    ...
    const generalOptions = isServerMode
      ? generalSettingList.filter((item) =>
          ["isDisableTrashBin", "isDeleteShelfBook", "isHideShelfBook"].includes(
            item.propName
          )
        )
      : generalSettingList;
    ...
    return (
      <SettingFormList>
        {this.renderSwitchOption(generalOptions)}

        {isElectron && !isServerMode && (
          <SettingFormRow
            title={<Trans>Reset main window's position</Trans>}
            control={
              <span
        ...
        <SettingFormRow
          title={<Trans>Default search engine</Trans>}
          control={
            <select
              name=""
              className="lang-setting-dropdown"
