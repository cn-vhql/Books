...
class Login extends React.Component<LoginProps, LoginState> {
  ...
  componentDidUpdate(prevProps: Readonly<LoginProps>): void {
    if (
      ...
      this.props.isAuthResolved &&
      this.props.isAuthed &&
      (!prevProps.isAuthed || !prevProps.isAuthResolved)
    ) {
  ...
  handleServerLogin = async () => {
    const username = (this.state.username || "").trim();
    const password = this.state.password || "";
    if (!username || !password) {
      toast.error(this.props.t("Missing parameters"));
      return;
    }
    this.props.handleLoadingDialog(true);
    try {
      await ServerLibrary.login(username, password);
      ...
      const message =
        error instanceof Error ? error.message : this.props.t("Login failed");
      toast.error(message);
    } finally {
      this.props.handleLoadingDialog(false);
    }
  ...
  render() {
    const renderBrand = () => <div className="login-brand">Books</div>;
    ...
    if (this.props.isServerMode) {
      return (
        <>
          ...
          <div
            className="login-container login-server-layout"
            style={{
              backgroundColor: "#efe4cf",
            }}
          >
            <div
              className="login-cover-container login-server-cover"
              style={{
            ...
            >
              ...
              <img
                ...
                alt="cover"
                className="login-cover-img login-server-cover-img"
              />
            </div>
            <div className="login-content-container login-server-content">
              <div className="login-server-card login-server-card-inline">
                <div className="login-server-header">
                  <div className="login-server-seal">藏</div>
                  <div className="login-server-heading">
                    <div className="login-server-title">Books</div>
                  </div>
                </div>
                <div className="login-server-form">
                  <label className="login-server-label">账号</label>
                  <input
                    className="login-server-input"
                    placeholder="请输入账号"
                  ...
                  />
                  <label className="login-server-label">密码</label>
                  <input
                    className="login-server-input"
                    type="password"
                    placeholder="请输入密码"
                  ...
                  <button
                    type="button"
                    className="login-server-button"
                    onClick={this.handleServerLogin}
                  >
                    进入书库
                  </button>
                </div>
          ...
          >
            ...
            <div className="login-content-container">
              ...
              <div className="login-subtitle">
                {this.props.t(
                  "After three years of design and development, the mobile version of Books is finally out"
                )}
              </div>
              <div
              ...
              <div className="login-option-box">
                <div>
                  ...
                  <div className="login-term">
                    {this.props.t(
                      "By clicking continue, you acknowledge that you have carefully read and agree to accept Books' Terms of Service and Privacy Policy"
                    )}
                  </div>
                </div>
              </div>
