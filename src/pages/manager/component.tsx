...
class Manager extends React.Component<ManagerProps, ManagerState> {
  ...
  componentDidUpdate(prevProps: ManagerProps) {
    if (
      this.props.isServerMode &&
      ((!prevProps.isServerMode && this.props.isServerMode) ||
        this.props.isAuthed !== prevProps.isAuthed ||
        this.props.isAuthResolved !== prevProps.isAuthResolved) &&
    ...
    if (
      this.props.isServerMode &&
      this.props.isAuthed &&
      prevProps.isAuthed !== this.props.isAuthed &&
        ...
        <div
          ...
          onDrop={async (e) => {
            ...
            if (!this.isUploadAllowed()) {
              toast.error(this.props.t("Only admin can upload books"));
              return;
            }
